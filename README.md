We provide a fast, simple & easy-to-integrate API for foreign currency exchange rate data. We provide super-fast JSON responses over HTTPS. Make API calls from any HTTP client or browser.
